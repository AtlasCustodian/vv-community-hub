...
const factionUsers = {
  ...
  wood: {
    ...
    champions: [
      ...
      { id: "wd-18", name: "Hazel Creekbend", returnRate: -0.001, stabilityScore: 81 },
  ...
  metal: {
    ...
    champions: [
      ...
      { id: "m-06", name: "Quill Parchmentis", returnRate: -0.002, stabilityScore: 75 },
      ...
      { id: "m-19", name: "Corvid Archivex", returnRate: 0.01, stabilityScore: 83 },
...
async function seed() {
  ...
  try {
    ...
    for (const u of allUsers) {
      await client.query(
        "INSERT INTO users (id, name, faction_id, balance, starting_balance, standing, is_champion) VALUES ($1, $2, $3, $4, $5, $6, $7)",
        [u.id, u.name, u.faction_id, u.balance, u.starting_balance, u.standing, u.is_champion]
      );
    }

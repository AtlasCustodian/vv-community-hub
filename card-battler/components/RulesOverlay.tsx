      ...
      >
        ...
        <div className="space-y-6 text-sm text-[var(--text-primary)]">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-1 text-[var(--text-muted)]">
              <li>
                <span className="text-[var(--text-primary)] font-medium">Draw</span> &mdash;
                Draw 1 card (if hand &lt; 5 and deck has cards).
              </li>
              <li>
                <span className="text-[var(--text-primary)] font-medium">Move</span> &mdash;
                Move any number of your champions 1 hex to an adjacent empty tile.
                You may also swap positions with an adjacent friendly unmoved champion.
              </li>
              <li>
                <span className="text-[var(--text-primary)] font-medium">Action</span> &mdash;
                Choose <em>one</em> action type: <strong>Attack</strong> with your champions,
                or <strong>Deploy</strong> a champion from your hand to any empty hex adjacent to
                one of your champions, as long as it is not adjacent to an opponent&apos;s champion.
                You cannot do both in the same turn.
              </li>
              <li>
                <span className="text-[var(--text-primary)] font-medium">Move Again</span> &mdash;
                A second move phase after your action.
              </li>
            </ol>
          </section>

      ...
      <section className="relative py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            >
              {faction.name} Protocols
            </span>
          </h1>
          <p className="mt-3 text-sm text-muted max-w-2xl mx-auto">
            A comprehensive guide to every feature and system available to{" "}
            {faction.name} members. This reference covers all tools, monitoring
            systems, and community features at your disposal.
          </p>
        </div>
      </section>
